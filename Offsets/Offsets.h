...
namespace Offset
{
	...
	bool UpdateOffsets();
	inline uintptr_t AnimGraph;
	inline uintptr_t ScenSystem;
	inline uintptr_t Fov_Changer;
	inline uintptr_t Aspect_Ratio;
	inline uintptr_t Fov_Offset;
	inline uintptr_t hkDrawSceneObject;
	inline uintptr_t LightSceneObject;
}